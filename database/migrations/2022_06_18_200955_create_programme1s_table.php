...
class CreateProgramme1sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('programme1s', function (Blueprint $table) {
            $table->id();
            $table->string('programme1')->default('programme 1');
            $table->string('annee');
            $table->string('site');
            $table->string('commun');
            $table->string('douar');
    ...
    {
        Schema::dropIfExists('programme1s');
    }
}
