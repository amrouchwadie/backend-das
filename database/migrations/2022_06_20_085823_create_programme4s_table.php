...
class CreateProgramme4sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('programme4s', function (Blueprint $table) {
            $table->id();
            $table->string('programme4')->default('programme 4');
            $table->string('annee');
            $table->string('site');
            $table->string('commun');
            $table->string('douar');
    ...
    {
        Schema::dropIfExists('programme4s');
    }
}
